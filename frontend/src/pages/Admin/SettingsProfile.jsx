...
import { FaUserCircle, FaUserCog, FaEdit, FaSave, FaTimes, FaSignOutAlt, FaEnvelope, FaPhone, FaMapMarkerAlt, FaGraduationCap, FaUser, FaShieldAlt, FaCog } from 'react-icons/fa';
        ...
        <ProfileContent>
          ...
          <ProfileGrid>
            <ProfileCard>
              ...
              <ProfileName>{adminInfo.name || 'Admin User'}</ProfileName>
              ...
              <FormGrid>
                ...
                <FormGroup>
                  ...
                  {editMode ? (
                    ...
                    <InfoDisplay>
                      {adminInfo.qualification || 'Not provided'}
                    </InfoDisplay>
                  )}
                </FormGroup>
